...
###
### CREDITS to @ash - Andrew Shitov - for original code taken from
### https://github.com/ash/rakupp/blob/main/showcase/sqlite/sqlite.raku
###

unit module Sparky::Minimal::Sqlite;
